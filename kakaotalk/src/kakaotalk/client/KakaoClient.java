...
public class KakaoClient extends JFrame {
    ...
    public KakaoClient() throws IOException {
        ...
        // 배경화면 이미지를 불러옵니다.
        final BufferedImage login_img = ImageIO.read(new File("./image/kakao.png"));
        final ImageIcon imgButton = new ImageIcon("./image/kakao_login_medium_narrow.png");
        final BufferedImage chatting_img = ImageIO.read(new File("./image/kakaoChatting.png"));
